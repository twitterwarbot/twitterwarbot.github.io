...
export default {
    ...
    computed: {
      shuffledWeapons: function () { return this.shuffle(this.weapons) },
      shuffledInjures: function () { return this.shuffle(this.injures) },
      shuffledPowerups: function () { return this.shuffle(this.powerups) },
    },
    methods: {
        shuffle(sourceArray) {
